...
export const emailTemplates = {
    ...
    * {status} - The status of the request
    ...
    "assignment_group_member":
    {
        ...
        "leave": {
            "subject": "{course_name} - You've been removed from group {assignment_group_name} for assignment {assignment_name}",
    ...
    "assignment_group_invitations": {
        "create": {
            "subject": "{course_name} - You've been invited by {inviter_name} to join group {assignment_group_name} for assignment {assignment_name}",
    ...
    "assignment_group_join_request": {
        "create": {
            "subject": "{course_name} - {requestor_name} has requested to join group {assignment_group_name} for assignment {assignment_name}",
        ...
        "update": {
            "subject": "{course_name} - Update on {requestor_name}'s request to join {assignment_group_name} for assignment {assignment_name}",
