DROP POLICY IF EXISTS "Deadline exceptions never inserted after early finish" ON "public"."assignment_due_date_exceptions";

-- Update the authorize_to_create_own_due_date_extension function to include protection against inserting an extension AFTER already having a negative extension
