-- Store rubric and comment points as numeric, and give update_rubric_full a
-- statement timeout.
--
-- Two defects in update_rubric_full, both pre-existing and both reachable from the
