...
-- Create pgmq queue for discord_async_calls
do $$
begin
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_schema = 'public' AND table_name = 'classes' AND column_name = 'discord_channel_group_id') THEN
    ALTER TABLE "public"."classes" ADD COLUMN "discord_channel_group_id" text;
  END IF;
END $$;

DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_schema = 'public' AND table_name = 'classes' AND column_name = 'discord_server_id') THEN
    ALTER TABLE "public"."classes" ADD COLUMN "discord_server_id" text;
  END IF;
END $$;

DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_schema = 'public' AND table_name = 'classes' AND column_name = 'events_ics_url') THEN
    ALTER TABLE "public"."classes" ADD COLUMN "events_ics_url" text;
  END IF;
END $$;

DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_schema = 'public' AND table_name = 'classes' AND column_name = 'office_hours_ics_url') THEN
    ALTER TABLE "public"."classes" ADD COLUMN "office_hours_ics_url" text;
  END IF;
END $$;

DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_schema = 'public' AND table_name = 'notification_preferences' AND column_name = 'regrade_request_notification') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_schema = 'public' AND table_name = 'users' AND column_name = 'discord_id') THEN
    ALTER TABLE "public"."users" ADD COLUMN "discord_id" text;
  END IF;
END $$;

DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_schema = 'public' AND table_name = 'users' AND column_name = 'discord_username') THEN
    ALTER TABLE "public"."users" ADD COLUMN "discord_username" text;
  END IF;
END $$;

CREATE UNIQUE INDEX IF NOT EXISTS calendar_events_class_id_calendar_type_uid_key ON public.calendar_events USING btree (class_id, calendar_type, uid);

CREATE UNIQUE INDEX IF NOT EXISTS calendar_events_pkey ON public.calendar_events USING btree (id);

CREATE UNIQUE INDEX IF NOT EXISTS calendar_sync_state_class_id_calendar_type_key ON public.calendar_sync_state USING btree (class_id, calendar_type);

CREATE UNIQUE INDEX IF NOT EXISTS calendar_sync_state_pkey ON public.calendar_sync_state USING btree (id);

CREATE UNIQUE INDEX IF NOT EXISTS class_staff_settings_class_id_setting_key_key ON public.class_staff_settings USING btree (class_id, setting_key);

CREATE UNIQUE INDEX IF NOT EXISTS class_staff_settings_pkey ON public.class_staff_settings USING btree (id);

CREATE INDEX IF NOT EXISTS discord_async_worker_dlq_messages_class_id_idx ON public.discord_async_worker_dlq_messages USING btree (class_id);

CREATE INDEX IF NOT EXISTS discord_async_worker_dlq_messages_created_at_idx ON public.discord_async_worker_dlq_messages USING btree (created_at DESC);

CREATE INDEX IF NOT EXISTS discord_async_worker_dlq_messages_method_idx ON public.discord_async_worker_dlq_messages USING btree (method);

CREATE UNIQUE INDEX IF NOT EXISTS discord_async_worker_dlq_messages_pkey ON public.discord_async_worker_dlq_messages USING btree (id);

CREATE UNIQUE INDEX IF NOT EXISTS discord_channels_class_id_channel_type_resource_id_key ON public.discord_channels USING btree (class_id, channel_type, resource_id);

CREATE UNIQUE INDEX IF NOT EXISTS discord_channels_class_id_discord_channel_id_key ON public.discord_channels USING btree (class_id, discord_channel_id);

CREATE UNIQUE INDEX IF NOT EXISTS discord_channels_pkey ON public.discord_channels USING btree (id);

CREATE UNIQUE INDEX IF NOT EXISTS discord_invites_pkey ON public.discord_invites USING btree (id);

CREATE UNIQUE INDEX IF NOT EXISTS discord_invites_user_id_class_id_guild_id_key ON public.discord_invites USING btree (user_id, class_id, guild_id);

CREATE UNIQUE INDEX IF NOT EXISTS discord_messages_class_id_discord_message_id_key ON public.discord_messages USING btree (class_id, discord_message_id);

CREATE UNIQUE INDEX IF NOT EXISTS discord_messages_class_id_resource_type_resource_id_key ON public.discord_messages USING btree (class_id, resource_type, resource_id);

CREATE UNIQUE INDEX IF NOT EXISTS discord_messages_pkey ON public.discord_messages USING btree (id);

CREATE UNIQUE INDEX IF NOT EXISTS discord_roles_class_id_role_type_key ON public.discord_roles USING btree (class_id, role_type);

CREATE UNIQUE INDEX IF NOT EXISTS discord_roles_pkey ON public.discord_roles USING btree (id);

CREATE INDEX IF NOT EXISTS idx_calendar_events_class_type ON public.calendar_events USING btree (class_id, calendar_type);

CREATE INDEX IF NOT EXISTS idx_calendar_events_end_time ON public.calendar_events USING btree (end_time);

CREATE INDEX IF NOT EXISTS idx_calendar_events_start_time ON public.calendar_events USING btree (start_time);

CREATE INDEX IF NOT EXISTS idx_calendar_events_unannounced_end ON public.calendar_events USING btree (class_id, end_time) WHERE (end_announced_at IS NULL);

CREATE INDEX IF NOT EXISTS idx_calendar_events_unannounced_start ON public.calendar_events USING btree (class_id, start_time) WHERE (start_announced_at IS NULL);

CREATE INDEX IF NOT EXISTS idx_calendar_sync_state_class ON public.calendar_sync_state USING btree (class_id);

CREATE INDEX IF NOT EXISTS idx_class_staff_settings_class ON public.class_staff_settings USING btree (class_id);

CREATE INDEX IF NOT EXISTS idx_class_staff_settings_key ON public.class_staff_settings USING btree (class_id, setting_key);

CREATE INDEX IF NOT EXISTS idx_discord_channels_class_id ON public.discord_channels USING btree (class_id);

CREATE INDEX IF NOT EXISTS idx_discord_channels_type_resource ON public.discord_channels USING btree (channel_type, resource_id);

CREATE INDEX IF NOT EXISTS idx_discord_invites_active ON public.discord_invites USING btree (user_id, class_id, used, expires_at) WHERE (used = false);

CREATE INDEX IF NOT EXISTS idx_discord_invites_class_id ON public.discord_invites USING btree (class_id);

CREATE INDEX IF NOT EXISTS idx_discord_invites_user_id ON public.discord_invites USING btree (user_id);

CREATE INDEX IF NOT EXISTS idx_discord_messages_channel ON public.discord_messages USING btree (discord_channel_id);

CREATE INDEX IF NOT EXISTS idx_discord_messages_class_resource ON public.discord_messages USING btree (class_id, resource_type, resource_id);

CREATE INDEX IF NOT EXISTS idx_discord_roles_class_id ON public.discord_roles USING btree (class_id);

CREATE INDEX IF NOT EXISTS idx_discord_roles_type ON public.discord_roles USING btree (class_id, role_type);

DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'calendar_events_pkey' AND conrelid = 'public.calendar_events'::regclass) THEN
    ALTER TABLE "public"."calendar_events" ADD CONSTRAINT "calendar_events_pkey" PRIMARY KEY USING INDEX "calendar_events_pkey";
  END IF;
END $$;

DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'calendar_sync_state_pkey' AND conrelid = 'public.calendar_sync_state'::regclass) THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'class_staff_settings_pkey' AND conrelid = 'public.class_staff_settings'::regclass) THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'discord_async_worker_dlq_messages_pkey' AND conrelid = 'public.discord_async_worker_dlq_messages'::regclass) THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'discord_channels_pkey' AND conrelid = 'public.discord_channels'::regclass) THEN
    ALTER TABLE "public"."discord_channels" ADD CONSTRAINT "discord_channels_pkey" PRIMARY KEY USING INDEX "discord_channels_pkey";
  END IF;
END $$;

DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'discord_invites_pkey' AND conrelid = 'public.discord_invites'::regclass) THEN
    ALTER TABLE "public"."discord_invites" ADD CONSTRAINT "discord_invites_pkey" PRIMARY KEY USING INDEX "discord_invites_pkey";
  END IF;
END $$;

DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'discord_messages_pkey' AND conrelid = 'public.discord_messages'::regclass) THEN
    ALTER TABLE "public"."discord_messages" ADD CONSTRAINT "discord_messages_pkey" PRIMARY KEY USING INDEX "discord_messages_pkey";
  END IF;
END $$;

DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'discord_roles_pkey' AND conrelid = 'public.discord_roles'::regclass) THEN
    ALTER TABLE "public"."discord_roles" ADD CONSTRAINT "discord_roles_pkey" PRIMARY KEY USING INDEX "discord_roles_pkey";
  END IF;
END $$;

DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'calendar_events_calendar_type_check' AND conrelid = 'public.calendar_events'::regclass) THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'calendar_events_class_id_calendar_type_uid_key' AND conrelid = 'public.calendar_events'::regclass) THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'calendar_events_class_id_fkey' AND conrelid = 'public.calendar_events'::regclass) THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'calendar_sync_state_calendar_type_check' AND conrelid = 'public.calendar_sync_state'::regclass) THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'calendar_sync_state_class_id_calendar_type_key' AND conrelid = 'public.calendar_sync_state'::regclass) THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'calendar_sync_state_class_id_fkey' AND conrelid = 'public.calendar_sync_state'::regclass) THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'class_staff_settings_class_id_fkey' AND conrelid = 'public.class_staff_settings'::regclass) THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'class_staff_settings_class_id_setting_key_key' AND conrelid = 'public.class_staff_settings'::regclass) THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'discord_async_worker_dlq_messages_class_id_fkey' AND conrelid = 'public.discord_async_worker_dlq_messages'::regclass) THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'discord_channels_class_id_channel_type_resource_id_key' AND conrelid = 'public.discord_channels'::regclass) THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'discord_channels_class_id_discord_channel_id_key' AND conrelid = 'public.discord_channels'::regclass) THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'discord_channels_class_id_fkey' AND conrelid = 'public.discord_channels'::regclass) THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'discord_invites_class_id_fkey' AND conrelid = 'public.discord_invites'::regclass) THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'discord_invites_user_id_class_id_guild_id_key' AND conrelid = 'public.discord_invites'::regclass) THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'discord_invites_user_id_fkey' AND conrelid = 'public.discord_invites'::regclass) THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'discord_messages_class_id_discord_message_id_key' AND conrelid = 'public.discord_messages'::regclass) THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'discord_messages_class_id_fkey' AND conrelid = 'public.discord_messages'::regclass) THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'discord_messages_class_id_resource_type_resource_id_key' AND conrelid = 'public.discord_messages'::regclass) THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'discord_roles_class_id_fkey' AND conrelid = 'public.discord_roles'::regclass) THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'discord_roles_class_id_role_type_key' AND conrelid = 'public.discord_roles'::regclass) THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'discord_roles_role_type_check' AND conrelid = 'public.discord_roles'::regclass) THEN
...
BEGIN
  ...
  -- office_hours → students channel (+ staff)
...
DECLARE
  ...
  v_term_code integer;
BEGIN
  -- Get Discord server info, class name, and term from class
  SELECT c.discord_server_id, c.name, c.term
  INTO v_guild_id, v_class_name, v_term
  FROM public.classes c
  WHERE c.id = p_class_id;
  ...
  -- Determine role name: {term text} {class name} {Role Type} ({class_id})
  -- Format: "Fall 2024 Class Name Student (123)" or "Class Name Student (123)" if no term
  v_role_name := format('%s%s %s (%s)',
    CASE WHEN v_term_text IS NOT NULL THEN v_term_text || ' ' ELSE '' END,
...
DROP TRIGGER IF EXISTS trg_broadcast_discord_channel_change ON public.discord_channels;
...
DROP TRIGGER IF EXISTS trg_broadcast_discord_message_change ON public.discord_messages;
...
DROP TRIGGER IF EXISTS trg_discord_help_request_feedback_notification ON public.help_request_feedback;
...
CREATE TRIGGER trg_update_discord_profile AFTER UPDATE ON auth.identities FOR EACH ROW EXECUTE FUNCTION public.update_discord_profile();
...
-- Schedule hourly batch sync cron job
...
-- Schedule daily slash command registration
