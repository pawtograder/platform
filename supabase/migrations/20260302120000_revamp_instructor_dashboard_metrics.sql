-- Revamp instructor dashboard metrics for accuracy and scalability.
-- Computes all assignment-level grading metrics in one RPC query.
...
GRANT EXECUTE ON FUNCTION public.get_instructor_dashboard_metrics(bigint, timestamptz) TO authenticated;
