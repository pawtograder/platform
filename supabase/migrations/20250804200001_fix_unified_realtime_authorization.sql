-- Fix unified realtime authorization function to support both gradebook and office hours channels
-- This migration combines the functionality from both the gradebook and office hours migrations
-- to ensure all realtime channel types are properly supported

-- Update the unified RLS authorization function to handle all channel types:
-- - gradebook channels (from gradebook migration)
-- - help_request channels (from office hours migration) 
-- - help_queue channels (from office hours migration)
-- - class channels (shared functionality)
-- - submission channels (shared functionality)
