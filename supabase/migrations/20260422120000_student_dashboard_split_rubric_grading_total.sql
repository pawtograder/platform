-- Student dashboard: grading_total_score must match per-student line for split rubrics
-- (per_student_grading_totals / individual_scores), not submission_reviews.total_score alone.
