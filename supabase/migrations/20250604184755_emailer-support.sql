...
CREATE TABLE IF NOT EXISTS "public"."email_ccs" (
    "id" bigint generated by default as identity not null,
    "user_id" uuid not null,
    "email_recipient_id" bigint not null,
    "class_id" bigint not null
);
...
ALTER TABLE "public"."email_recipients" 
    ...
    ALTER TABLE "public"."email_ccs" 
    ADD CONSTRAINT "email_ccs_pkey" PRIMARY KEY ("id");
...
ALTER TABLE "public"."email_ccs" ENABLE ROW LEVEL SECURITY;
...
ALTER TABLE "public"."email_ccs"
    ADD CONSTRAINT "email_ccs_class_id_fkey" FOREIGN KEY ("class_id") REFERENCES "public"."classes"("id");

ALTER TABLE "public"."email_ccs"
    ADD CONSTRAINT "email_ccs_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."users"("user_id");
...
create policy "Instructors can view email_ccs"
on "public"."email_ccs"
as permissive
for select
to authenticated
...
create policy "Instructors can create email_ccs"
on "public"."email_ccs"
as permissive
for insert
to authenticated
...
create policy "Instructors can update email_ccs"
on "public"."email_ccs"
as permissive
for update
to authenticated
...
create policy "Instructors can delete email_ccs"
on "public"."email_ccs"
as permissive
for delete
to authenticated
