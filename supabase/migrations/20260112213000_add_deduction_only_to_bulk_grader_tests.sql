-- Update submissionreviewrecompute_bulk_grader_tests to handle deduction_only mode
-- (matches the fix applied to submissionreviewrecompute in previous migration)
