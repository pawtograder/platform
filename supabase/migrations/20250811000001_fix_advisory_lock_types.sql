-- Fix pg_advisory_xact_lock parameter type mismatch in gradebook_auto_layout function
-- The function was calling pg_advisory_xact_lock(integer, bigint) which doesn't exist
-- Need to cast the first parameter to bigint to match the second parameter
