...
BEGIN
    ...
    WHERE submission_id IN (
        ...
        WHERE s.assignment_id = release_all_grading_reviews_for_assignment.assignment_id
...
BEGIN
    ...
    WHERE submission_id IN (
        SELECT s.id 
        FROM public.submissions s 
        WHERE s.assignment_id = unrelease_all_grading_reviews_for_assignment.assignment_id
    );
