...
-- Allow service role full access; minimal for anon/auth
...
as $$
begin
  insert into public.api_gateway_calls(type, status_code, class_id, debug_id, message_enqueued_at, latency_ms)
  values (p_type, p_status_code, p_class_id, p_debug_id, p_message_enqueued_at, p_latency_ms);
end;
$$;
