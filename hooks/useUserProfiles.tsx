...
export function useUserProfile(id: string | null | undefined): { flair?: string, flair_color?: string, id: string, name: string, avatar_url: string, real_name?: string } | undefined {
