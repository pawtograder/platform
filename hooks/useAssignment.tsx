...
function AssignmentControllerCreator({
  ...
  const { query: assignmentQuery } = useShow<AssignmentWithRubricsAndReferences>({
    ...
    meta: {
      select:
        "*, self_review_settings(*), review_assignments!review_assignments_assignment_id_fkey(*, review_assignment_rubric_parts(*)), rubrics!rubrics_assignment_id_fkey(*, rubric_parts(*, rubric_criteria(*, rubric_checks(*, rubric_check_references!referencing_rubric_check_id(*)))))"
    }
  });
