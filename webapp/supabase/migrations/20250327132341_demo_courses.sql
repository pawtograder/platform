alter table public.classes add column is_demo boolean default false;

update public.classes set  is_demo = false;

alter table public.classes alter column is_demo set not null;
