...
export default function HelpRequestForm() {
    ...
    const { refineCore: { formLoading, query },
        ...
        register,
        control,
        formState: { errors } } = useForm<HelpRequest>({
            refineCoreProps: {
    ...
    return <form>
        ...
        <Fieldset.Root size="lg" maxW="md">
            <Fieldset.Content>
                <Field label="Queue" errorText={errors.help_queue?.message?.toString()} invalid={errors.help_queue ? true : false}>
                    <Controller
                        name="help_queue"
                        control={control}
                        render={({ field }) => (
            ...
            <Fieldset.Content>
                <Field label="Message" errorText={errors.message?.message?.toString()} invalid={errors.message ? true : false}>
