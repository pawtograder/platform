...
function RubricCheckSubMenuOrItem({
  ...
  criterion: RubricCriteriaSelectGroupOption;
  option: RubricCheckSelectOption;
  handleItemClick: (
  ...
  handleDisplayClick: (event: React.MouseEvent<SVGGElement, MouseEvent>, position: string) => void;
}) {
...
function RubricCriteriaSubMenuOrItem({
  criterion,
  handleItemClick,
  handleSubItemClick,
  handleDisplayClick
...
export function RubricMarkingMenu({
  criteria,
  top,
  left,
  ...
  criteria: RubricCriteriaSelectGroupOption[];
  top: number;
  left: number;
  setSelectedCheckOption: (option: RubricCheckSelectOption | null) => void;
  setSelectedSubOption: (option: RubricCheckSubOptions | null) => void;
  setCurrentMode: (mode: "marking" | "select") => void;
}) {
