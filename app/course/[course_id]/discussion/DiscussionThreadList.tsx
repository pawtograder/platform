...
import { Avatar, Badge, Box, Button, Flex, Heading, HStack, Icon, Input, Select, Separator, Spacer, Stack, Text, VStack, Portal, createListCollection } from "@chakra-ui/react";
        ...
        >
            ...
            <Stack spaceY="0" fontSize="sm" flex="1" truncate>
                ...
                <Box color="fg.subtle" truncate>
                    ...
                    <HStack>
                        <Text fontSize="xs" color="text.muted">{thread?.children_count ?? 0} replies</Text>
...
export default function DiscussionThreadList() {
    ...
    const processedList = useMemo(() => {
        ...
        if (filterOption === 'unread') {
            ...
            filteredList = list.filter(thread => thread.author === public_profile_id || thread.author === private_profile_id);
    ...
    return <Flex width="314px"
        ...
        <Box p="4" w="100%">
            <Heading size="md" mb="2">Discussion Feed</Heading>
        ...
        <Box width="100%" flex={1} overflowY="auto" pr="4">
            <Box role="list" aria-busy={list === undefined} aria-live="polite" aria-label="Discussion threads">
                ...
                {processedList.length === 0 && <Text p="4" color="text.muted">No threads match your criteria.</Text>}
