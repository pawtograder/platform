  ...
  const onSubmitWrapper = useCallback(
    async (values: FieldValues) => {
      ...
      const valuesWithDates = {
        ...
        suggested_due_date: appendTimezoneOffset(values.suggested_due_date, timezone),
              ...
              <Controller
                ...
                rules={{
                  validate: (value: string) => {
                    ...
                    const dueDateValue = form.getValues("due_date");
                    if (!dueDateValue) return true;
                    const suggested = new TZDate(value, timezone).getTime();
                    const due = new TZDate(dueDateValue, timezone).getTime();
