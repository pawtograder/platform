            ...
            <Table.Body>
                {submissions.data.map((submission) => (
                    <Table.Row key={submission.id}>
                        ...
                        <Table.Cell><Link href={`/course/${course_id}/assignments/${assignment_id}/submissions/${submission.id}`}>{submission.submission_reviews?.completed_at ? `${submission.submission_reviews?.total_score}/${assignment.data.total_points}` : submission.is_active ? "Pending" : ""}</Link></Table.Cell>
                    </Table.Row>
                ))}
            </Table.Body>
        </Table.Root>
