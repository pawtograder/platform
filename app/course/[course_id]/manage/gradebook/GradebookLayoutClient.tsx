...
import { GradebookProvider, type GradebookRecordsForStudent } from "@/hooks/useGradebook";
import { Box } from "@chakra-ui/react";
import { useEffect } from "react";

export default function GradebookLayoutClient({
  children,
  ...
  return (
    <GradebookProvider initialGradebookRecords={initialGradebookRecords}>
