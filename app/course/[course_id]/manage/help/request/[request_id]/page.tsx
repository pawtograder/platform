    ...
    return (
      <Text>
        ...
        <IconButton
          ...
          onClick={() => updateRequest({ id: request.id, values: { assignee: null } })}
        >
    ...
    return (
      <Text>
        ...
        <IconButton
          ...
          variant="outline"
          onClick={() => updateRequest({ id: request.id, values: { assignee: private_profile_id } })}
        >
...
export default function HelpRequestPage() {
  ...
  return (
    <HelpRequestChatChannelProvider help_request={activeRequest.data}>
      <HelpRequestChat
