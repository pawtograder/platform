...
const DevicePermissionPrompt = () => {
  ...
  return status === DeviceLabelTriggerStatus.IN_PROGRESS ? (
    ...
    >
      <ModalHeader title="Device Label Permissions check" displayClose={false} />
      <ModalBody>
        <Card
          title="Unable to get device labels"
          description={
            <>
              <p>In order to select media devices, we need to do a quick permissions check of your mic and camera.</p>
              <p>
