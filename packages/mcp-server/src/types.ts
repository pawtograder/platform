/**
 * Types for the Pawtograder MCP Server
...
// MCP context that gets passed to tools
...
// Tool input types
export interface GetHelpRequestInput {
  help_request_id: number;
  class_id: number;
}

export interface GetDiscussionThreadInput {
  thread_id: number;
  class_id: number;
...
export interface GetSubmissionsForStudentInput {
...
export interface SearchHelpRequestsInput {
  class_id: number;
  assignment_id?: number;
  status?: string;
  limit?: number;
...
export interface SearchDiscussionThreadsInput {
  class_id: number;
  assignment_id?: number;
  is_question?: boolean;
  search_query?: string;
