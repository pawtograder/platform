 ...
 * Task: discussion__discussion-reply   (generator v1)
 * Source trajectory: 0fb0248933ff259456df95533cd8333cf285c0053d3b9c39d7d36176e0488665 (run eval-clean)
...
const PLAN: ReplayPlan = {
  "generatorVersion": "1",
  "sourceTrajectoryHash": "0fb0248933ff259456df95533cd8333cf285c0053d3b9c39d7d36176e0488665",
  "pageId": "discussion",
  ...
  "steps": [
    ...
    {
      "command": "type",
      "arg": "Screen reader navigation check reply.",
      "milestone": "reply..."
    },
    {
...
test("replay: discussion__discussion-reply", async ({ page }) => {
