 ...
 * Task: autograder-results__results-score   (generator v1)
 * Source trajectory: c9d0133cd39dedb281c25ac7919b13c7eb5a67d2b1fad44c796542cf98fb6c62 (run eval-clean)
...
const PLAN: ReplayPlan = {
  "generatorVersion": "1",
  "sourceTrajectoryHash": "c9d0133cd39dedb281c25ac7919b13c7eb5a67d2b1fad44c796542cf98fb6c62",
  "pageId": "autograder-results",
  "taskId": "results-score",
  "taskKind": "read",
  "readNeedleKeys": [
    "autograderScore",
    "autograderMax"
...
test("replay: autograder-results__results-score", async ({ page }) => {
