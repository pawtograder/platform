 ...
 * Task: grade-summary__grade-assignment-name   (generator v1)
 * Source trajectory: 02de2665e89a816bebe7f47835e956e0aa616ba004de9d415dcf13002d7e3eb5 (run eval-clean)
...
const PLAN: ReplayPlan = {
  "generatorVersion": "1",
  "sourceTrajectoryHash": "02de2665e89a816bebe7f47835e956e0aa616ba004de9d415dcf13002d7e3eb5",
  "pageId": "grade-summary",
  "taskId": "grade-assignment-name",
  "taskKind": "read",
  "readNeedleKeys": [
    "assignmentName"
  ],
...
test("replay: grade-summary__grade-assignment-name", async ({ page }) => {
